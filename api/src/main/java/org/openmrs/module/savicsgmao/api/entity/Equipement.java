...
public class Equipement implements java.io.Externalizable {
	...
	public Equipement(int EquipmentTypeId, String SerialNumber, Date AcquisitionDate, Integer Status, String Designation,
	    String Localization, Integer DepartmentId, Date LastModifiedDate, Float Weight, Float Volume, Integer Tracking,
	    Integer InService, Integer OperatingState, Integer CommissioningYear, String Comments, Integer ProviderId) {
