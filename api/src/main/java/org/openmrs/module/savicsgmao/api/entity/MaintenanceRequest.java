...
public class MaintenanceRequest extends BaseOpenmrsData  implements java.io.Serializable {
    ...
    public MaintenanceRequest(Department Department, Equipment Equipment, String uuid, String systemNumber, String applicantName, String registerNumber, Date startdate, String natureOfWork, String motif, int requestPriority) {
    ...
    public MaintenanceRequest(Department Department, Equipment Equipment, String uuid, String systemNumber, String applicantName, String registerNumber, Date startdate, String natureOfWork, Date enddate, String motif, int requestPriority) {
        this.Department = Department;
        this.Equipment = Equipment;
        this.uuid = uuid;
        this.systemNumber = systemNumber;
