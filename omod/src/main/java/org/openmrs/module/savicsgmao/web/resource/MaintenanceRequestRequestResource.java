...
public class MaintenanceRequestRequestResource extends DelegatingCrudResource<MaintenanceRequest> {
    ...
    private MaintenanceRequest constructAgent(String uuid, SimpleObject properties) {
        ...
        if (properties.get("Equipment") != null) {
            String regionId = properties.get("Equipment");
            equipment = (Equipment) Context.getService(GmaoService.class).getEntityByid(Equipment.class, "regionId", regionId);
        }

        Department department = null;
        if (properties.get("Department") != null) {
            String departmentId = properties.get("Department");
            department = (Department) Context.getService(GmaoService.class).getEntityByid(Equipment.class, "departmentId", departmentId);
        }
