...
public class MaintenanceTaskRequestResource extends DelegatingCrudResource<MaintenanceTask> {
    ...
    private MaintenanceTask constructAgent(String uuid, SimpleObject properties) {
        ...
        if (properties.get("Maintenance") != null) {
            ...
            maintenance = (Maintenance) Context.getService(GmaoService.class).getEntityByid(Maintenance.class, "maintenanceId", maintenanceId);
        }
        
        Planification planification = null;
        if (properties.get("Planification") != null) {
            String planificationId = properties.get("Planification");
            planification = (Planification) Context.getService(GmaoService.class).getEntityByid(Planification.class, "planificationId", planificationId);
        }
