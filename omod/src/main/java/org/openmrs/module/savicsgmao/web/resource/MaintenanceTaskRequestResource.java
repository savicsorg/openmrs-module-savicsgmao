	...
	private MaintenanceTask constructAgent(String uuid, SimpleObject properties) {
		...
		if (uuid != null) {
			...
			if (properties.get("maintenanceId") != null) {
				maintenanceTask.setMaintenanceId((Integer) properties.get("maintenanceId"));
			}
			
			if (properties.get("equipementId") != null) {
				maintenanceTask.setEquipementId((Integer) properties.get("equipementId"));
			}
			
			if (properties.get("planificationId") != null) {
				maintenanceTask.setPlanificationId((Integer) properties.get("planificationId"));
			}
